...
<aside class="w-72 shrink-0 transition-all duration-200 bg-blue-50 text-slate-800" x-data="{
        ...
        if (this.currentPath.includes('/admin/receipt_vouchers') 
            ...
            || this.currentPath.includes('/admin/supplier-debts')) {
    ...
    <nav class="px-2 pb-6 text-base mt-6">
        ...
        <div class="mt-2">
            <a href="/admin/chat-support"
                :class="['flex items-center gap-2 px-3 py-2 rounded', currentPath.startsWith('/admin/chat-support') ? 'bg-[#002975] text-white' : 'hover:bg-[#002975] hover:text-white']">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
