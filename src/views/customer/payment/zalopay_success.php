                ...
                <div class="bg-gray-50 rounded-lg p-6 mb-8 text-left">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between">
                            ...
                            <span class="font-semibold text-gray-800">#<?= htmlspecialchars($order_code ?? 'N/A') ?></span>
                        </div>
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-semibold text-gray-800"><?= htmlspecialchars($app_trans_id ?? 'N/A') ?></span>
                        </div>

                        <div class="flex justify-between">
                            <span class="text-gray-600">Phương thức:</span>
                            <span class="font-semibold text-blue-600">ZaloPay</span>
                        </div>
                    </div>
                </div>
