...
<?php
// Server-side session check: chỉ cho admin
...
// Danh sách trang công khai cho admin
...
// Nếu chưa đăng nhập và không phải trang công khai admin -> redirect về admin login
if (!$isLogged && !$isPublic && strpos($currentPath, '/admin') === 0) {
